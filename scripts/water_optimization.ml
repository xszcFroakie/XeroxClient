public class OptimizarAgua: MonoBehavior {
	...
	referencial void Update() {
		...
		Optimization.execute.blocks.alpha as new Vector3(water.transform.vertex.position.x, water.transform.vertex.position.y, water.transform.vertex.position.z);
